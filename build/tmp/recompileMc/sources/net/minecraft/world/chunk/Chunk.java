...
public class Chunk
{
    ...
    private void logCascadingWorldGeneration()
    {
        ...
        if (activeModContainer == null) // vanilla minecraft has problems too (MC-114332), log it at a quieter level.
            net.minecraftforge.fml.common.FMLLog.fine(format, "Minecraft", this.xPosition, this.zPosition, this.world.provider.getDimension());
        else
            net.minecraftforge.fml.common.FMLLog.warning(format, activeModContainer.getName(), this.xPosition, this.zPosition, this.world.provider.getDimension());
    }
}